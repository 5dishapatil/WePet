"""
recommendation_engine.py — Dynamic, breed-specific, justified recommendations.
"""
from services.risk_engine import clamp
...
def generate_recommendations(
    ...
    # ─── Maine Coon / Golden / German Shepherd (large + dense coat) ──────────
...
def generate_emergency_signs(breed: dict) -> dict:
    """Return emergency watch signs for this breed with safe language."""
    return {
