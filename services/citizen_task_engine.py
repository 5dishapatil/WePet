"""
citizen_task_engine.py — Task selection logic for Community User mode.
"""
import json
import random
...
TASKS_FILE = Path(__file__).parent.parent / "data" / "citizen_tasks.json"
...
def select_task(heat_level: str) -> dict:
    ...
    # Use date as seed for consistent daily task (same task all day)
